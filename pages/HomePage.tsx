      ...
      <div className="relative flex items-center justify-center min-h-screen text-center px-4 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          >
            <Link
              to="/portfolio"
              className="shimmer-button group block px-6 py-3 border border-white text-white uppercase text-sm tracking-widest hover:bg-white hover:text-black transition-all duration-300"
            >
